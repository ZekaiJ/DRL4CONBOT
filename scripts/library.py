...
def records(text):
    ...
    if len(result)!=134 or len({r['id'] for r in result})!=134:
        raise ValueError('Catalog must contain 134 distinct reports')
    return result
